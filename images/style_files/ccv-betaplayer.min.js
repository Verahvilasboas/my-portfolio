var __extends=this&&this.__extends||function(){var e=function(f,b){e=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(a,d){a.__proto__=d}||function(a,d){for(var c in d)d.hasOwnProperty(c)&&(a[c]=d[c])};return e(f,b)};return function(f,b){function a(){this.constructor=f}e(f,b);f.prototype=null===b?Object.create(b):(a.prototype=b.prototype,new a)}}(),com$adobe$ccv$util;
(function(e){var f=function(){function b(){}b.prototype.generateRandomString=function(a){for(var d="",c=0;c<a;c++)var b=Math.floor(61*Math.random()),d=d+"0123456789ABCDEFGHIJKLMNOPQRSTUVWXTZabcdefghiklmnopqrstuvwxyz".substring(b,b+1);return d};b.prototype.formatDoubleDigit=function(a){return 10>a?"0"+a:String(a)};b.prototype.formatTime=function(a,d){void 0===d&&(d=!1);var c=Math.round(a),b=0,h=0;if(isFinite(c)&&0<c){for(;59<c;)h++,c-=60;for(;59<h;)b++,h-=60;return 0<b?d?this.formatDoubleDigit(b)+
":"+this.formatDoubleDigit(h)+":"+this.formatDoubleDigit(c):b+":"+this.formatDoubleDigit(h)+":"+this.formatDoubleDigit(c):d?this.formatDoubleDigit(h)+":"+this.formatDoubleDigit(c):h+":"+this.formatDoubleDigit(c)}return d?"00:00":"0:00"};b.prototype.getExtension=function(a){var d=a.lastIndexOf(".");return a.substr(d+1,a.length)};b.prototype.getPrefix=function(a){return a.substring(0,a.indexOf("://"))};b.prototype.getFilename=function(a){return a.substr(a.lastIndexOf("/")+1)};b.prototype.reverse=function(a){return null===
...
d,c)||this._setDebugConfigProperty(a,d,c)||this._setClientConfigProperty(a,d,c))||this._error("_setConfigProperty: unknown property '"+d+"'");return a};b._getValueFromQueryString=function(a,d){var c="undefined"!=typeof d&&d.location.search.substr(1).split("&");if(""!=a&&c&&0<c.length)for(var b=0;b<c.length;++b){var h=c[b].split("=");if(2==h.length&&h[0]==a)return decodeURIComponent(h[1].replace(/\+/g," "))}};b.prototype.getConfigValue=function(a,d){var c=this._element,c=c?c.data(a):null;if("number"==
...
d.theme=c.theme||d.theme);if(c=a.debugging)d.debug=c.debug||d.debug,d.log_info=c.log_info||d.log_info,d.log_warn=c.log_warn||d.log_warn,d.log_debug=c.log_debug||d.log_debug,d.log_error=c.log_error||d.log_error;if(a=a.client)d.bgcolor=a.bgcolor||d.bgcolor,d.clientid=a.clientid||d.clientid,d.locale=a.locale||d.locale,d.plugins=a.plugins||d.plugins}};b.prototype.loadSettings=function(a){function d(a){b._applySettings(a);c.resolve(a)}var c=$.Deferred(),b=this;window.ccv$serverData&&window.ccv$serverData.settings?
d(window.ccv$serverData.settings):jQuery.getJSON(a,function(a,b,g){200==g.status?d(a):c.reject()}).fail(function(){c.reject()});return c.promise()};b.prototype.hasData=function(a){return this._defaultConfigValues.hasOwnProperty(a)};return b}();e.Configuration=f})(com$adobe$ccv$app||(com$adobe$ccv$app={}));
...
function(a){this._isEnabled()&&(a=this._logger.indexOf(a),0<=a&&this._logger.splice(a,1))};a.prototype.setCapacity=function(a){if(this._isEnabled())for(var c=this._logger.length,b=0;b<c;++b)this._logger[b].setCapacity(a)};a.prototype.clear=function(){if(this._isEnabled())for(var a=this._logger.length,c=0;c<a;++c)this._logger[c].clear()};a.prototype.info=function(a,c){if(this._getLogLevel()&f.LEVEL_INFO)for(var b=this._logger.length,h=0;h<b;++h)this._logger[h].info(a,c)};a.prototype.debug=function(a,
c){if(this._getLogLevel()&f.LEVEL_DEBUG)for(var b=this._logger.length,h=0;h<b;++h)this._logger[h].debug(a,c)};a.prototype.warn=function(a,c){if(this._getLogLevel()&f.LEVEL_WARN)for(var b=this._logger.length,h=0;h<b;++h)this._logger[h].warn(a,c)};a.prototype.error=function(a,c){if(window.hasOwnProperty("NREUM"))try{throw Error([a,": ",c].join(""));}catch(b){window.NREUM.noticeError(b)}if(this._getLogLevel()&f.LEVEL_ERROR)for(var h=this._logger.length,k=0;k<h;++k)this._logger[k].error(a,c)};return a}();
...
(function(e){var f=function(){function b(a,d,c,b,h,k){void 0===k&&(k=null);var m=$(document.createElement("div"));m.addClass(a);a=$(document.createElement("div"));a.addClass("message-background");m.append(a);a=$(document.createElement("span"));a.addClass("message");m.append(a);var u=$(document.createElement("p"));u.addClass("title");a.append(u);if(d&&d.length){var e=$(document.createElement("img"));e.addClass(c);e.attr("src",d);k&&k.length?(d=$(document.createElement("a")),d.attr("href",k),d.attr("target",
"_blank"),d.append(e),u.append(d)):u.append(e)}u.append(b);if(h){b=$(document.createElement("p"));b.addClass("subtitle");h=h.split("\n");for(k=0;k<h.length;++k)b.append(h[k]),b.append($(document.createElement("br")));a.append(b)}this._msg=m}b.prototype.showMsg=function(a){a=a.find(".message-container");a.css("display","block");this._msg.appendTo(a);this._msg.css("display","block");$("#spinner-control").css("visibility","hidden");$("#startcover").css("visibility","hidden")};b.prototype.hideMsg=function(){this._msg.parent().css("display",
...
(function(e){var f=function(){function b(a,d){this._videoID=a;this._authToken=d}b.prototype._loadSrc=function(){this._loaded=!1;this._loadTimer=0;var a=e.Constants.API_ROOT+this._videoID+"/posterframe";this._authToken&&(a+="?Authorization="+this._authToken);this._img.attr("src",a);return this};b.prototype.addPoster=function(a){var d=this;this._poster=a.find("#html5-video-poster");this._poster.css("display","none");this._img=$(document.createElement("img")).addClass("poster");this._img.on("load",function(a){LOGGING&&
Log.info(b._LOGTAG,"addPoster: poster has been successfully loaded");d._loaded=!0;d._shouldShow&&d.showPoster()});this._img.on("error",function(a){LOGGING&&Log.info(b._LOGTAG,"addPoster: fetching poster failed, retrying in "+e.Constants.WWW_SERVICE_POLL_WAIT+"ms");d._loadTimer=window.setTimeout(jQuery.proxy(d._loadSrc,d),e.Constants.WWW_SERVICE_POLL_WAIT)});this._loadSrc();this._poster.append(this._img);return this};b.prototype.showPoster=function(){if(!this._loaded)return this._shouldShow=!0,this;
var a=this._poster.parent().width(),d=this._poster.parent().height(),c=this._poster.find("img"),b=c.get(0),h=b.width,k=b.height,b=a,m=d;if(b!=h||m!=k)m=a/h*k,m>d&&(m=d,b=d/k*h);a=a/2-b/2;c.css("top",(d/2-m/2).toString()+"px");c.css("left",a.toString()+"px");c.css("width",b.toString()+"px");c.css("height",m.toString()+"px");this._poster.css("display","block");return this};b.prototype.hidePoster=function(){LOGGING&&Log.info(b._LOGTAG,"hidePoster");this._shouldShow=!1;this._loadTimer&&(clearTimeout(this._loadTimer),
...
(function(e){var f=function(b){function a(a,c,g,h){var k=b.call(this)||this;k._LOGTAG="ConversionMonitor";k.app=a;k.posterShown=!1;k.width=c;k.height=g;k.poster=h;k.msg=new e.Message("conversion-in-progress-message",k.app.rootdir+"/img/Spinner.gif","spinner",com$adobe$ccv$localization.StringSet.getString("%conversion_in_progress"),com$adobe$ccv$localization.StringSet.getString("%conversion_in_progress_sub"));return k}__extends(a,b);a.prototype.initTask=function(){this.msg.hideMsg();if(this.app.status==
...
(function(e){var f=function(){function b(){this._LOGTAG="Settings"}b.prototype.load=function(a,d){void 0===d&&(d=null);var c=$.Deferred(),b=this;d=d||a.getConfigValue("rootdir");var h=a.getConfigValue("clientid").toLowerCase(),k=d+"json/"+h+"/config.json";a.loadSettings(k).done(function(){LOGGING&&Log.info(b._LOGTAG,"Settings successfully loaded "+k)}).fail(function(){var c=d+"json/default/config.json";c!=k&&(LOGGING&&Log.error(b._LOGTAG,"Settings failed to load "+k+" loading default "+c),a.loadSettings(c).done(function(){LOGGING&&
Log.info(b._LOGTAG,"Settings default successfully loaded "+c)}).fail(function(){LOGGING&&Log.error(b._LOGTAG,"Settings default failed to load "+c)}))}).always(function(){b._loadStrings(a,d,h).done(function(){c.resolve(a)}).fail(function(){c.reject(a)})});return c.promise()};b.prototype._loadStrings=function(a,d,c){var b=$.Deferred(),h=this,k=d+a.getConfigValue("strings_json");com$adobe$ccv$localization.StringSet.loadStrings(k).done(function(){LOGGING&&Log.info(h._LOGTAG,"Strings successfully loaded "+
...
function(a){var d=$.Deferred();this.createPlayer(a).done(function(a){a.onSizeChange(null);d.resolve(a)}).fail(function(){d.reject()});return d.promise()};b.prototype._processPage=function(a){var d=$.Deferred();if(this.status==e.Constants.STATUS_OK)LOGGING&&Log.info(this._LOGTAG,"processPage: STATUS_OK, creating player"),this._createPlayer(a).done(function(a){d.resolve(a)}).fail(function(){d.reject()});else if(this.status==e.Constants.STATUS_GEN_POSTER||this.status==e.Constants.STATUS_GEN_PLAYLIST){LOGGING&&
Log.info(this._LOGTAG,"processPage: STATUS_GEN_POSTER|STATUS_GEN_PLAYLIST");var c=new e.Poster(this.videoID,this.authToken);c.addPoster(a);var b=new e.ConversionMonitor(this,this.videoWidth,this.videoHeight,c);b.attachTo(a.find("#html5-video-holder")).done(function(d){b.removeFrom(a.find("#html5-video-holder"));document.location.reload(!0)}).fail(function(){d.reject()})}else this.status==e.Constants.STATUS_INVALID?(LOGGING&&Log.info(this._LOGTAG,"processPage: STATUS_INVALID"),this.showError(e.ErrorMessages.getInstance(this.rootdir).getInvalidMsg())):
this.status==e.Constants.STATUS_BAD_ASSET?(LOGGING&&Log.info(this._LOGTAG,"processPage: STATUS_BAD_ASSET"),this.showError(e.ErrorMessages.getInstance(this.rootdir).getBadAssetMsg())):this.status==e.Constants.STATUS_REMOVED?(LOGGING&&Log.info(this._LOGTAG,"processPage: STATUS_REMOVED"),this.showError(e.ErrorMessages.getInstance(this.rootdir).getRemovedMsg())):(LOGGING&&Log.info(this._LOGTAG,"processPage: unknown status="+this.status),this.showError()),d.reject();return d.promise()};b.prototype.processPage=
function(a){var d=$.Deferred(),c=this;this.serverData=window.ccv$serverData;var b=this.config;(new e.Settings).load(b,this.rootdir).always(function(h){c._processPage(a).done(function(){d.resolve(c)}).fail(function(){d.reject()})});return d.promise()};b.prototype.onSizeChange=function(a){LOGGING&&Log.error(this._LOGTAG,"onSizeChange: please override")};b.prototype.getAuthorizedJSON=function(a,d){void 0===d&&(d=2E4);var c={};c.url=a;c.type="GET";c.dataType="json";c.timeout=d;c.cache=!1;this.authToken&&
(c.headers={"X-USER-TOKEN":this.authToken});return jQuery.ajax(c)};b.prototype.makeAjaxCall=function(a,d){var c=this;jQuery.ajax(a).fail(function(b,h,k){0<d&&b.status!=e.Constants.BAD_PARAMS_CODE&&(LOGGING&&Log.warn(self._LOGTAG,"sendPlayCountBeacon: retry sending beacon to "+a.url),d--,c.makeAjaxCall(a,d))})};b.prototype.onFirstPlay=function(){if(this.serverData&&this.serverData.playCountBeacon){var a=this.serverData.playCountBeaconRetry||0,d=this.serverData.playCountBeacon;LOGGING&&Log.info(this._LOGTAG,
"sendPlayCountBeacon: beacon sent to "+d.url);0==(d.headers&&"string"==typeof d.headers["Content-Type"]?d.headers["Content-Type"]:"").indexOf("application/json")&&d.data&&"string"!=typeof d.data&&(d.data=JSON.stringify(d.data));this.makeAjaxCall(d,a)}};return b}();e.PlayerApp=f})(com$adobe$ccv$app||(com$adobe$ccv$app={}));var com$adobe$ccv$typekit;
...
(function(e){var f=function(b){function a(a){var c=b.call(this)||this;c.prefix=a;c.videoPosterID=a+"-video-poster";c.videoHolderID=a+"-video-holder";c.videoWidth=0;c.videoHeight=0;return c}__extends(a,b);a.prototype._init=function(a,c,b,h,k,m,u){this.element=a;this.url=b;this.poster=h;this.videoWidth=k;this.videoHeight=m;this.rootFolder=u;return this.configuration=c};a.prototype.attachTo=function(a,c,g,h,k,m,u){this._init(a,c,g,h,k,m,u);return b.prototype.attachToElement.call(this,a,this.videoHolderID)};
...
(function(e){var f=function(){function b(){this.DESKTOP_MIN_SIZE=480}b.prototype.setHtml=function(a,d){try{a.html(d)}catch(c){$(d).each(function(d,c){a.append(c)})}return a};b.prototype.now=function(){return(new Date).valueOf()};b.prototype.windowInnerWidth=function(a){void 0===a&&(a=window);var d=a.innerWidth;if(this.isIE(a)&&8==this.ieVersion(a))return $(window).width();this.isIOSDevice(a)&&(this.isIPhone(a)||this.isIPod(a))&&(a=a.innerHeight,320==a?d=480>=d?480:568:375==a?d=667:414==a&&(d=736));
...
a&&(a=window);var d=a.devicePixelRatio?a.devicePixelRatio:1,c=a.screen.width/d,g=a.screen.height/d;if(a.navigator.userAgent.toLowerCase().match(/(iphone|ipod|ipad|android)/))return!1;c=c<g?c:g;g=c>this.DESKTOP_MIN_SIZE;LOGGING&&Log.info(b._LOGTAG,"result="+g+", "+c+" > "+this.DESKTOP_MIN_SIZE+", ratio="+d+", ww="+a.screen.width+", wh="+a.screen.height);return g};b.prototype.isMobileDevice=function(a){void 0===a&&(a=window);return this.isTouchDevice(a)&&!this.isDesktopScreen(a)};b.prototype.isSafari=
...
b;b=function(a){function d(){return null!==a&&a.apply(this,arguments)||this}__extends(d,a);d.prototype.getMessageWithTimestamp=function(a,d,b){return(new Date).toString()+a+" "+d+" "+b};d.prototype.sendMessage=function(a,d,b){return this.getMessageWithTimestamp(" ["+a+"] :",d,b)};d.prototype.addLogger=function(a){};return d}(b);e.ServerLogger=b})(com$adobe$ccv$logging||(com$adobe$ccv$logging={}));
...
(function(e){var f=function(){function b(){this._plugins=[]}b.prototype.registerPlugin=function(a){this._plugins.push(a)};b.prototype.unregisterPlugin=function(a){for(var d,c=this._plugins.length,b=0;b<c;++b)if(d=this._plugins[b],d===a)return this._plugins.splice(b,1),d.shutdown(),!0;return!1};b.prototype.attachTo=function(a,d){var c=$.Deferred(),g=this;if(0<d.getConfigValue("plugins").length){var h=d.getConfigValue("rootdir");$.getScript(h+"/js/ccv-plugins.min.js",function(h,m,u){if(200==u.status){LOGGING&&
Log.info(b._LOGTAG,"plugins loaded from ccv-plugins.min.js");var e=0;h=g._plugins.slice(0);var f=h.length;if(0==f)c.resolve(g);else for(m=0;m<f;++m)h[m].attachTo(a,d).done(function(a){++e==f&&c.resolve(g)})}else LOGGING&&Log.error(b._LOGTAG,"failed to loaded ccv-plugins.min.js"),c.reject(g)})}else c.resolve(g);return c.promise()};b.prototype.shutdown=function(){for(var a=this._plugins.length,d=0;d<a;++d)this._plugins[d].shutdown();this._plugins.splice(0);this._plugins=null};b._LOGTAG=LOGGING?"PluginManager":
...
return b.prototype.initTask.call(this)};a.prototype.isAttachedTo=function(a,b,g,h,k,m){return this.element&&this.element.css("id")==a.css("id")&&this.url==b&&this.poster==g&&this.videoWidth==h&&this.videoHeight==k&&this.rootFolder==m};a.prototype.attachTo=function(d,c,g,h,k,m,u){var s=$.Deferred(),f=this;com$adobe$ccv$logging.ConsoleLogger.isAvailable()&&console.info(a._LOGTAG,"[ccv] Creative Cloud Player "+e.Version.getVersion());f.configuration=c;this.state="INIT";"skin"==c.getConfigValue("test")&&
(g&&0!=g.length||(g=window.location.href,0==c.getConfigValue("bcid").length&&(g=c.getConfigValue("bcid"),g=e.Constants.DEFAULT_HOST+e.Constants.API_ROOT+g+"/info")),h&&0!=h.length||(h=c.getConfigValue("test_poster")));"default"==c.getConfigValue("theme")&&(DOMUtil.useMobileTheme()?(LOGGING&&Log.info(a._LOGTAG,"Using theme=mobile"),c.setConfigValue("theme","mobile")):c.setConfigValue("theme","desktop"));b.prototype.attachTo.call(this,d,c,g,h,k,m,u).done(function(){LOGGING&&Log.info(a._LOGTAG,"attachTo: successfully attached");
f.updateHtml(d,this.videoHolderID,h);d.attr("data-timestamp",DOMUtil.now().toString());c.getConfigValue("plugins").length&&PluginManager.attachTo(d,c);f.onSuccess();s.resolve(this)}).fail(function(){LOGGING&&Log.error(a._LOGTAG,"attachTo: failed to attach");s.reject(this)});return s.promise()};a.prototype.getPromise=function(){return this.deferred.promise()};a.prototype.changeSize=function(a,b){};a._LOGTAG="CloudPlayer";a.instance=null;return a}(e.CoreCloudPlayer);e.CloudPlayer=f})(com$adobe$ccv$app||
...
Math.floor(100*a);0==b?(this._lastVolume=0<this.getVolume()/100?this.getVolume()/100:0.5,this._$volButton.addClass("muteicon")):this._$volButton.removeClass("muteicon");this._$volLevelIndicator.val(b+"");this._$volLevelIndicator.text(b+"");this.isSlideEnabled&&this._updateVolumeIndicator(a);this._updateMuteButtonText()}};a.prototype.getFocusableElements=function(){return[this._$volSlider.get(0),this._$volButton.get(0)]};return a}(com$adobe$ccv$view.BaseView);e.VolumeControl=f})(com$adobe$ccv$controls||
...
b;b-=g;g=this._$vidoeTimeLineWrapper.outerWidth();if(0<=a&&a<=g){var h=a/g*this._duration;this._thumbnail&&this._thumbnail.showThumbnail(h,a,b,g);this.updateProgressTooltip(h);var h=this._$duration.outerWidth(!0)/2,k=0,k=0>a-h?0:a-h;a>=g-h&&(k=g-this._$duration.outerWidth(!0));if(this._thumbnail){var m=this._thumbnail.settings.thumbnailWidth/2,k=0>k-(m-h)?m-h:k;k+h+m>g&&(k=g-(m+h))}this._$duration.css("left",k+b);this._$duration.addClass("show").removeClass("hide");b=a-Number(this._$hoverLine.data("x"));
0>b?this._$hoverLine.addClass("dark"):this._$hoverLine.removeClass("dark");this._$hoverLine.data("nw",a);this._$hoverLine.css("transform","scaleX("+b+")")}else this._$duration.addClass("hide").removeClass("show")};a.prototype.updateProgressBar=function(a){this._sliding||this._percent==a||this._updateProgressBar(a)};a.prototype.updateProgressTooltip=function(a){this._$duration.html(StringUtil.formatTime(a))};a.prototype._updateTimelineSliderAriaText=function(a){a=StringUtil.formatTime(a,!0);var b=
StringUtil.formatTime(this._duration,!0);a=a+" of "+b;this._$vidoeTimeLineWrapper.attr("aria-label","timeline slider "+a);this._$slider.attr("aria-valuetext",a)};a.prototype.setDuration=function(a){this._duration=a;return this};a.prototype.getDuration=function(){return this._duration};a.prototype.getPercent=function(){return this._percent};a.prototype.isSliding=function(){return this._sliding||this._hovering};a.prototype.changeSize=function(a,b){};a.prototype.isThumbnailHidden=function(){return this._thumbnail?
this._thumbnail.isThumbnailHidden():!0};a.prototype.enable=function(){this.$el.css("pointer-events","auto")};a.prototype.disable=function(){this.$el.css("pointer-events","none")};a.prototype.getFocusableElements=function(){return[this._$vidoeTimeLineWrapper.get(0)]};a.prototype.focusTimelineWrap=function(){var a=this,b=0;this._$vidoeTimeLineWrapper.is(":focus")&&(this._$vidoeTimeLineWrapper.blur(),b=200);setTimeout(function(){return a._$vidoeTimeLineWrapper.focus()},b);setTimeout(function(){return a._$vidoeTimeLineWrapper.blur()},
...
""));var a=this;setTimeout(function(){var b=a._pressEscMsg.getMsgDiv(),g=DOMUtil.windowInnerHeight()/3-b.height()/2;b.css("margin-top",g.toString()+"px");a._pressEscMsg.showMsg(a._$videoContainer);b.fadeIn(4E3,function(){b.fadeOut(3E3,function(){a._pressEscMsg.hideMsg()})})},1E3)};a.prototype.showFullscreenState=function(){LOGGING&&Log.info(this._LOGTAG,"showFullscreenState");this._$controlScreen.hasClass("show-normal-screen")||(this._$controlScreen.addClass("show-normal-screen"),this.$el.addClass("full-screen-mode"),
...
(function(e){var f=function(){function b(){this._LOGTAG="CookiesUtil"}b.prototype.createCookie=function(a,b,c){void 0===c&&(c=-1);var g="";0<=c&&(g=new Date,g.setTime(g.getTime()+864E5*c),g="; expires="+g.toUTCString());document.cookie=a+"="+b+g+"; path=/";LOGGING&&this.readCookie(a)!=b&&Log.warn(this._LOGTAG,"ccv: Can't save cookie "+a+"="+b)};b.prototype.readCookie=function(a){a+="=";for(var b=document.cookie.split(";"),c=0;c<b.length;c++){for(var g=b[c];" "==g.charAt(0);)g=g.substring(1,g.length);
...
return this};c.prototype._addControlSubscribers=function(){LOGGING&&Log.info(this._LOGTAG,"_addControlSubscribers");var a=this;this.controlbarHolder.on("play",function(b){LOGGING&&Log.info(a._LOGTAG,"_addControlSubscribers: play");a.play()}).on("pause",function(b){LOGGING&&Log.info(a._LOGTAG,"_addControlSubscribers: pause");a.pause()});this._$progressHolderNew.on("progressUpdate",function(a){}).on("progressDown",function(){LOGGING&&Log.info(a._LOGTAG,"progressDown");a.showLoader()}).on("progressUp",
function(b){b=a.durationControl.getDuration();var c=a.progressControl.getPercent();b*=c;LOGGING&&Log.info(a._LOGTAG,"progressUp: updating to "+b);a._seek(b)});this._$volumeHolderNew.on("volumeUpdate",function(b){a._options.volume=b.percent;a.videoPlayer.setVolume(b.percent);a.saveSettings()});return this};c.prototype.changeVideo=function(a){this._changedQuality=!0;this.showLoader().setVideoSource(a).pause().destroy();this.videoPlayer.load();this._gotDuration=!1;return this};c.prototype.pause=function(){var a=
this;this.videoPlayer.pause();this.playPauseControl&&this.playPauseControl.showPauseState();this._playAfterExitFullscreen=!1;this.showControls();this._killAutoHideControls();this.isVideoCompletelyWatched||this.videoPlayer.getCurrentTime(function(c){a.sendDunamisEvent(b.PAUSE,Math.round(c))});return this};c.prototype.isValidOffsetParameter=function(a,b,c,d){return 1<a||1<c||1<b||0<d?!1:!0};c.prototype.calculateStartOffset=function(a){var b=0,c=this._options.duration,d=(a.match(/m/g)||[]).length,e=
(a.match(/s/g)||[]).length,s=(a.match(/h/g)||[]).length,f=(a.match(/[^msh0-9]/g)||[]).length,q=d+e+s,l=0,r=0,v=0;this.isValidOffsetParameter(d,e,s,f)&&(0==q?b=parseInt(a,10):(0!=s&&(a=a.split("h"),l=parseInt(a[0],10),a=a[1]),0!=d&&(d=a.split("m"),r=parseInt(d[0],10),a=d[1]),0!=e&&(e=a.split("s"),v=parseInt(e[0],10),a=e[1])),isFinite(v)&&isFinite(r)&&isFinite(l)&&""==a&&(b=3600*l+60*r+v));b>=Math.floor(c)&&(b=0);return b};c.prototype.play=function(){var a=this;this.hideControls();if(this._dataLoaded||
this._options.playVideoOnInit)return this.videoPlayer.play(),this.playPauseControl&&this.playPauseControl.showPlayState(),this.progressControl.enable(),this.videoHolder.hasClass("idle")?(this.hidePlayIcon(),this.sendDunamisEvent(b.START)):this.isVideoCompletelyWatched?(this.sendDunamisEvent(b.REPLAY),this.isVideoCompletelyWatched=!1):this.isPlayedAfterPause&&this.videoPlayer.getCurrentTime(function(c){a.sendDunamisEvent(b.RESUME,Math.round(c))}),this};c.prototype.onMouseEnter=function(a){this.showControls()};
c.prototype.onMouseLeave=function(a){this.hasEverPlayed&&this.playPauseControl.isPlaying()&&this.hideControls()};c.prototype.onMouseMove=function(a){DOMUtil.useMobileTheme()?this._delayAutoHideControls():this.showControls()};c.prototype._killAutoHideControls=function(){0<=this._autoHideControlsTimer&&(clearTimeout(this._autoHideControlsTimer),this._autoHideControlsTimer=-1)};c.prototype._delayAutoHideControls=function(a){void 0===a&&(a=this._autoHideControlsTimeoutMS);this.hasEverPlayed&&(this._killAutoHideControls(),
this._autoHideControlsTimer=window.setTimeout(jQuery.proxy(this.hideControls,this),a))};c.prototype.showControlBarHolder=function(){(this._dataLoaded||this._options.playVideoOnInit)&&this.controlbarHolder.removeClass("hide").addClass("show")};c.prototype.showControls=function(){this.showControlBarHolder();this.playPauseControl.isPlaying()&&this._delayAutoHideControls();this.$el.trigger("showControls")};c.prototype.hideControls=function(){this._options.autoHide&&this._hideControls()};c.prototype._hideControls=
function(){this.progressControl.isSliding()?this._delayAutoHideControls():(LOGGING&&Log.info(this._LOGTAG,"hideControls"),this.hasEverPlayed=!0,this._killAutoHideControls(),this.controlbarHolder.removeClass("show").addClass("hide"),this.$el.trigger("hideControls"))};c.prototype._onPlayPauseVideoContainer=function(a){DOMUtil.useMobileTheme()&&!this.controlbarHolder.hasClass("show")?this.showControls():this.playPauseControl.isPlaying()?(LOGGING&&Log.info(this._LOGTAG,"_onPlayPauseVideoContainer: play -> pause."),
this.pause()):(LOGGING&&Log.info(this._LOGTAG,"_onPlayPauseVideoContainer: pause -> play."),this.play())};c.prototype._onFullscreenVideoContainer=function(){this.screenControl._isFullScreen()?this.screenControl.showNormalState():this.screenControl.showFullscreenState()};c.prototype.sendDunamisEvent=function(a,b){this.dunamisEventSender.sendEvent(DunamisEventFactory.getEvent(a,b))};c.prototype.showLoader=function(){this.spinner.addClass("show").removeClass("hide");DOMUtil.isIPhone(window)||this._loadingSpinner.show();
return this};c.prototype.hideLoader=function(){if(this._dataLoaded||DOMUtil.isEdge()||DOMUtil.isIOS()||DOMUtil.isIE())this.displayPlayIcon(),this._dataLoaded=!0,this.spinner.removeClass("show").addClass("hide"),DOMUtil.isIPhone(window)||this._loadingSpinner.hide();return this};c.prototype.onDataLoad=function(){this.displayPlayIcon();this._dataLoaded=!0;return this.hideLoader()};c.prototype.onVideoTimeUpdate=function(a){this.onVideoProgress(a)};c.prototype.onVideoDurationChange=function(a){this.videoPlayer.getDuration(function(a){this.durationControl.setDuration(a);
this.durationControl.setDuration(a);this.progressControl.setDuration(a);this.progressControl.setDuration(a);0<a?(this.progressControl.enable(),this.progressControl.enable()):(this.progressControl.disable(),this.progressControl.disable())})};c.prototype.onVideoProgress=function(a){var c=this;this._gotDuration||this._setupDurationControl();if(this.playPauseControl.isPlaying()){var d=this.durationControl.getDuration();this.videoPlayer.getCurrentTime(function(a){LOGGING&&!d&&Log.info(c._LOGTAG,"onVideoProgress: duration is null");
LOGGING&&!a&&Log.info(c._LOGTAG,"onVideoProgress: current is null");LOGGING&&d&&a&&-1!=c._seekingTo&&Log.info(c._LOGTAG,"onVideoProgress: skipping updates during seeking, "+a+" > "+c._seekingTo);c.durationControl.updateCurrentTime(a);a-c.previous_time>=c.logging_interval&&(c.previous_time=a,c.sendDunamisEvent(b.ENGAGEMENT,c.percent_played));if(d&&a&&a>=c._seekingTo){var e=a/d;c._seekingTo=-1;c.progressControl.updateProgressBar(e)}c._lastTime=a;c._rewind&&0<=a&&1>a&&(LOGGING&&Log.info(c._LOGTAG,"onVideoProgress: rewind completed"),
c._rewind=!1)})}};c.prototype._onVideoComplete=function(a){LOGGING&&Log.info(this._LOGTAG,"_onVideoComplete");this.isVideoCompletelyWatched||(this.isVideoCompletelyWatched=!0,this.sendDunamisEvent(b.COMPLETE));this._rewind?(LOGGING&&Log.info(this._LOGTAG,"_onVideoComplete: rewinding"),this._rewind=!1,this._seek(0),this.videoPlayer.setCurrentTime(0),this.progressControl.updateProgressBar(0),this.durationControl.updateCurrentTime(0)):this.playPauseControl.isPlaying()&&(LOGGING&&Log.info(this._LOGTAG,
"_onVideoComplete: play -> pause"),this.pause(),this.hasEverPlayed=this._playAfterExitFullscreen=!1,this.showControls(),this._killAutoHideControls(),this._seekingTo=-1,this._options.withAutoRewind?(LOGGING&&Log.info(this._LOGTAG,"_onVideoComplete: auto-rewinding"),this.videoPlayer.setCurrentTime(0),this.progressControl.updateProgressBar(0),this.durationControl.updateCurrentTime(0),this.play()):(LOGGING&&Log.info(this._LOGTAG,"_onVideoComplete: showing replay state"),a=this.durationControl.getDuration(),
this.progressControl.updateProgressBar(100),this.durationControl.updateCurrentTime(a),this.playPauseControl.showReplayState()))};c.prototype._onVideoError=function(a){};c.prototype._onVideoPause=function(a){LOGGING&&Log.info(this._LOGTAG,"_onVideoPause");this.playPauseControl.isPlaying()&&this.playPauseControl.showPauseState()};c.prototype._onVideoRewind=function(a){var b=this;LOGGING&&Log.info(this._LOGTAG,"_onVideoRewind");this._rewind=!0;this._seek(0);setTimeout(function(){b.isPlayedAfterPause=
!1;b.play();b.isPlayedAfterPause=!0},300)};c.prototype._onWebkitBeginFullscreen=function(a){LOGGING&&Log.info(this._LOGTAG,"_onWebkitBeginFullscreen")};c.prototype._onWebkitEndFullscreen=function(a){LOGGING&&Log.info(this._LOGTAG,"_onWebkitEndFullscreen");this.volumeControlNew.setVolume(this.videoPlayer.getVolume());window.location.hash="#";window.location.hash="#share";this._$fullScreenElement.get(0).removeAttribute("controls");this._checkReplay();this._updateSize();this.pause()};c.prototype.goFullscreen=
function(a){LOGGING&&Log.info(this._LOGTAG,"goFullscreen");a||(a=this._$fullScreenElement.get(0));this._playAfterExitFullscreen=this.playPauseControl.isPlaying();this.videoPlayer.goFullscreen(a)};c.prototype.exitFullscreen=function(){LOGGING&&Log.info(this._LOGTAG,"exitFullScreen");this.videoPlayer.exitFullscreen();this._checkReplay();this._playAfterExitFullscreen&&(this._playAfterExitFullscreen=!1,this.play());this._updateSize()};c.prototype._checkReplay=function(){if(DOMUtil.isIPhone()||DOMUtil.isIPod()){var a=
this,b=this.durationControl.getDuration();this.showControls();this._killAutoHideControls();this.videoPlayer.getCurrentTime(function(c){b&&c&&(0.1>b-c?(LOGGING&&Log.info(a._LOGTAG,"exitFullscreen: showing replay state"),a._playAfterExitFullscreen=!1,a.hasEverPlayed=!1,b=a.durationControl.getDuration(),a.progressControl.updateProgressBar(100),a.durationControl.updateCurrentTime(b),a.playPauseControl.showReplayState()):(a.progressControl.updateProgressBar(c/b),a.durationControl.updateCurrentTime(c)))})}};
c.prototype.changeSize=function(a,b){LOGGING&&Log.info(this._LOGTAG,"changeSize: "+a+", "+b);var c=this.spinner,d=this.$el.width(),e=this.$el.height(),d=a/2-d/2,e=b/2-e/2;LOGGING&&Log.info(this._LOGTAG,"changeSize spinner: "+d+", "+e+"("+c.width()+", "+c.height()+")");c.css("left",d.toString()+"px");c.css("top",e.toString()+"px");this.videoPlayer.changeSize(a,b);c=this._videoJSElement.offset().top+this._videoJSElement.outerHeight(!0)-this.controlbarHolder.outerHeight(!0);this.progressControl.changeSize(a,
b);this.controlbarHolder.width(this.videoPlayer.getSize().width);this.controlbarHolder.css("bottom","");this.controlbarHolder.css("top",c+"px");this.videoHolder.width(a);this.videoHolder.height(b)};c.prototype.getSize=function(){return{width:this.videoHolder.width(),height:this.videoHolder.height()}};c.prototype._updateSize=function(){var a=DOMUtil.windowInnerWidth(),b=DOMUtil.windowInnerHeight();LOGGING&&Log.info(this._LOGTAG,"_updateSize: using window w="+a+", h="+b);this.changeSize(a,b)};c.prototype._onResize=
function(a){LOGGING&&Log.info(this._LOGTAG,"_onResize");this._updateSize()};c.prototype._onPostMessage=function(a){(a=a.originalEvent.data)&&"string"==typeof a&&0==a.indexOf("resize::")&&(LOGGING&&Log.info(this._LOGTAG,"_onPostMessage: "+a),this._updateSize())};c.prototype.saveSettings=function(){CookiesUtil.createCookie("volume",this._options.volume.toString())};c.prototype.loadSettings=function(){this._options.volume=parseFloat(CookiesUtil.readCookie("volume"));isNaN(this._options.volume)&&(this._options.volume=
0.5);return this._options.volume};return c}(e.BaseView);e.CoreView=a})(com$adobe$ccv$view||(com$adobe$ccv$view={}));
(function(e){var f=function(b){function a(a){return b.call(this,a)||this}__extends(a,b);a.prototype.createVideoPlayer=function(){return null};a.prototype.createCoreViewOptions=function(a,b,e,h){var k=this.configuration.isConfigOptionEnabled("lazyLoading"),m=this.configuration.isConfigOptionEnabled("autoplay"),u=this.configuration.isConfigOptionEnabled("loop"),s=this.configuration.isConfigOptionEnabled("muted"),f=this.configuration.getConfigValue("offset","0");return{el:a,volume:-1,duration:parseFloat(this.configuration.getConfigValue("duration")),
autoPlay:m,playVideoOnInit:k,offsetTime:f,autoHide:"false"!==this.configuration.getConfigValue("autohide"),preload:"metadata",allowairplay:!0,embedded:!1,poster:e,videoPlayer:h,sources:[{src:b,bitrate:"480",quality:"MED",defaultVideo:!0}],withAutoRewind:u,muted:s}};a.prototype.embedPlayer=function(b,c,e){LOGGING&&Log.info(a._LOGTAG,"_embedPlayer");var h=this.createVideoPlayer();b=this.createCoreViewOptions(b,c,e,h);this._player=new com$adobe$ccv$view.CoreView(b)};a.prototype.setPoster=function(a){b.prototype.setPoster.call(this,
...
'<div class="videogradient"></div><div class="timelinewrap"><div class="timelineknob"><div class="timeknob"></div></div><div class="duration"> 0.00 </div><div class="videotimewrap" tabindex="0" aria-label="timeline slider"><input class="timelineslide" type="range" tabindex="-1"  min="0" max="1" step="0.0001" aria-label="timeline"><div class="timeline" style="width:0%;"></div><div class="buffer" style="left: 0px; right: 0%;"></div><div class="track"></div><div class="hoverline dark"></div></div></div><div class="controlsleft"><button class="playpause videobutton playicon" tabindex="0">play</button><div class="videotime"><span class="timelabel">0:00</span><span class="vduration"></span></div></div><div class="controlsright"><div class="volumecontrols"><button class="videobutton mute level2 muteicon" tabindex="0">mute</button><span class="standard volumewrap"><div class="slidelabel" style="display:none;"><span class="sll">Volume</span><span class="slr volumelevel">0</span></div><div style="position:relative;z-index:1;height:100%;"><input type="range" class="slider volume" tabindex="0" max="100" aria-label="volume slider control"></div></span><div class="volumeslide" tabindex="-1" aria-label="volume slider"><div class="volumetracks"><div class="volumetrack"></div><div class="volumefill" style="width: 0%;"></div></div><div class="volumeknob" style="transform: translateX(-48px);"><div class="volumeknobfill"></div></div></div></div><button class="videobutton fullscreen" tabindex="0">fullscreen</button></div>')};
...
isNaN(this._maxFrameHeight)){if(e&&h&&(a!=e||d!=h)){LOGGING&&a!=e&&Log.info(b._LOGTAG,"changeSize: w != fw, "+a+"!="+e);LOGGING&&d!=h&&Log.info(b._LOGTAG,"changeSize: h != fh, "+d+"!="+h);var m=d;d=a/e*h;d>m&&(d=m,a=d/h*e)}a=Math.round(a);d=Math.round(d)}else k=!0,isNaN(this._maxFrameHeight)?a=this._maxFrameWidth:d=this._maxFrameHeight;LOGGING&&Log.info(b._LOGTAG,"changeSize: w="+a+", h="+d);this.videoElement.width(a);this.videoElement.height(d);this.player.width(a);this.player.height(d);!k&&c>d?
...
function(a,c,e,h,k,m,u){var s=$.Deferred();this._config=c;if(this.isAttachedTo(a,e,h,k,m,u))s.resolve(this);else{var f=this;b.prototype.attachTo.call(this,a,c,e,h,k,m,u).done(function(){f._disableVideoJSUI(a);s.resolve(f)}).fail(function(){s.reject(f)})}return s.promise()};a.prototype._disableVideoJSUI=function(a){a=a.find(".video-js");a.find(".vjs-poster").hide();a.find(".vjs-text-track-display").hide();a.find(".vjs-loading-spinner").hide();a.find(".vjs-big-play-button").hide();a.find(".vjs-control-bar").hide()};
a.prototype.setVideoJSPlayer=function(a){a.controls(!1);this.videoJSPlayer=a};a.prototype._showPoster=function(){this.element.find(".vjs-poster").show()};a.prototype._hidePoster=function(){this.element.find(".vjs-poster").hide()};a.prototype.embedPlayer=function(d,c,e){function h(){m.videoPlayer.trigger("canplay",null);m.videoPlayer.updateFrameSize();"visible"!=m.videoPlayer.getAttr("visibility")&&(m.videoPlayer.play(),m.videoPlayer.pause(),m.videoPlayer.setCurrentTime(0),m.videoJSPlayer.posterImage.show(),
m._showPoster())}function k(){var b=m.videoJSPlayer.duration();Infinity===b||s<f?s>=u?(LOGGING&&Log.error(a._LOGTAG,""),h()):(++s,LOGGING&&Log.info(a._LOGTAG,"Waiting for video-js, attempt #"+s+" of "+u),setTimeout(k,100)):(LOGGING&&Log.info(a._LOGTAG,"video-js is ready, duration="+b),h())}var m=this,u=20,s=0,f=1;b.prototype.embedPlayer.call(this,d,c,e);this._registerEvents();k();this.$fullScreenElement&&this.getCoreView().setFullScreenElement(this.$fullScreenElement)};a.prototype._registerEvents=
...
c,e,h){return b.prototype.createCoreViewOptions.call(this,a,c,e,h)};a.prototype.changeSize=function(a,b){this.getCoreView()&&this.getCoreView().changeSize(a,b)};a._LOGTAG="VideoJSCloudPlayer";return a}(com$adobe$ccv$app.HTMLCloudPlayer);e.VideoJSCloudPlayer=f})(com$adobe$ccv$videojs||(com$adobe$ccv$videojs={}));
...
(function(e){function f(a){var b=a>>>16;a&=65535;return 0==a?b:b+a/65535}var b=function(){function a(){}a.prototype.parseHeaders=function(a){var b={},c,d,e;if(!a)return b;a.split("\n").forEach(function(a,h,f){e=a.indexOf(":");c=a.substr(0,e).trim().toLowerCase();d=a.substr(e+1).trim();c&&(b[c]=b[c]?b[c]+", "+d:d)});return b};a.prototype.supportsCORS=function(a){var b=$.Deferred();a=function(a,b){var c=new XMLHttpRequest;c.open(a,b,!0);return c}("GET",a);a.onload=function(){b.resolve(!0)};a.onerror=
...
e=$.Deferred();d._greaterOrEqualFileSize(a,c).then(function(f){(f?d.getFileSize(a,c,2*c):d._getFileSize(a,b,c)).then(function(a){e.resolve(a)},function(){e.reject()})},function(){e.reject()});return e.promise()};a._LOGTAG="FileSizeEvaluator";return a}(),d=function(){function b(a){this._http=a}b.prototype._calculateFileSize=function(c,d){var e=$.Deferred(),u=new a(this._http),f=d.videoTrackInfo,x=Math.floor(f.pixelWidth*f.pixelHeight*0.28)*d.duration,f=Math.floor(x-x/2),x=Math.ceil(x+x/2);u.getFileSize(c,
f,x).then(function(a){LOGGING&&Log.warn(b._LOGTAG,"File size for "+c+" is aprox. "+a);d.fileSize=a;e.resolve(d)},function(){e.reject()});return e.promise()};b.prototype.parse=function(a,b){var c=this,d=$.Deferred();c._http.supportsCORS(a).done(function(e){e?c._doParse(a).then(function(a){0<b&&(a.duration=b);d.resolve(a)},function(){d.reject()}):d.reject()});return d.promise()};b.prototype._doParse=function(a){function b(a,k){d.parseSegment(a,0,k).then(function(a){c.resolve(a)},function(a){c.reject()})}
...
c.substring(c.lastIndexOf("/")+1),d.totalFileSize=parseInt(c,10),d.mp4Asset.fileSize=d.totalFileSize;b(a,d.totalFileSize)},function(a){console.error("Request failed:"+a.toString())});return c.promise()};b.prototype.parseSegment=function(a,c,d){var e=this,f=$.Deferred();this.getNextTag(c).then(function(x){e.parseType(x.type,c+8,x.size-8).then(function(q){q?f.resolve(e.mp4Asset):0==d||c+x.size<d?(LOGGING&&Log.info(b._LOGTAG,"Found '"+x.type+"', looking for 'moov'..."),e.parseSegment(a,c+x.size,0<d?
d-x.size:0).then(function(a){f.resolve(a)},function(a){f.reject()})):(LOGGING&&Log.error(b._LOGTAG,"Can't locate 'moov' tag in "+a),f.reject())},function(a){f.reject()})},function(a){f.reject()});return f.promise()};b.prototype.getNextTag=function(a){var b=$.Deferred();this.getData(a,8).then(function(c){var d=new DataView(c.buffer);c=d.getUint32(0);d=d.getType(4);b.resolve({size:c,type:d,offset:a+8})},function(){b.reject()});return b.promise()};b.prototype.getNextTagInDataView=function(a,b){var c=
...
f=this,g;this.getData(a,b).then(function(a){a=new DataView(a.buffer);for(var h=0,v=!1;!v;){var t=f.getNextTagInDataView(a,h);f.updateProcessMoovProgress(h);if("mvhd"==t.type)f.parseMVHD(a,h+8,t.size-8);else if("trak"==t.type){var y=f.parseTRAK(a,h+8,t.size-8);y.headerInfo.audio?d=y:y.headerInfo.video&&(c=y)}h+=t.size;b-=t.size;0>=b&&(v=!0)}g=f.analyze(c,d);e.resolve(g)},function(){e.reject()});return e.promise()};b.prototype.parseMVHD=function(a,b,c){var d=b,e=a.getUint8(d),d=d+1+3;0==e?(b=a.getUint32(d),
...
b+=4):(c.modificationTime=a.getUint64(b),b+=8);c.timeScale=a.getUint32(b);b+=4;c.duration=0==d?a.getUint32(b):a.getUint64(b);return c};b.prototype.parseTKHD=function(a,b){var c={},d=a.getUint8(b);b+=1;var s=a.getUint32(b);if(1==(s>>>8&1)){b+=3;0==d?(c.creationTime=a.getUint32(b),b+=4):(c.creationTime=a.getUint64(b),b+=8);0==d?(c.modificationTime=a.getUint32(b),b+=4):(c.modificationTime=a.getUint64(b),b+=8);c.index=a.getUint32(b);b=b+4+4;0==d?(c.duration=a.getUint32(b),b+=4):(c.duration=a.getUint64(b),
b+=8);b+=8;c.videoLayer=a.getUint16(b);b+=2;b+=2;c.volume=a.getUint16(b);b+=2;b+=2;d=f(a.getUint32(b));b+=4;s=f(a.getUint32(b));b+=4;b+=4;var g=f(a.getUint32(b));b+=4;var q=f(a.getUint32(b));b+=4;b+=4;var l=f(a.getUint32(b));b+=4;var r=f(a.getUint32(b));b+=4;b+=4;c.matrix=new e.TransformationMatrix(d,s,0,g,q,0,l,r,1);c.width=f(a.getUint32(b));b+=4;c.height=f(a.getUint32(b))}return c};b.prototype.parseTRAK=function(a,b,c){for(var d={},e=!1,f=!1,g,l,r,v,t=!1;!t;){var y=this.getNextTagInDataView(a,b);
this.updateProcessMoovProgress(b);"tkhd"==y.type&&(g=this.parseTKHD(a,b+8),d.headerInfo=g);if("mdia"==y.type)for(var p=!1,w=b+8,n=y.size-8;!p;){var D=this.getNextTagInDataView(a,w);this.updateProcessMoovProgress(w);if("hdlr"==D.type){var C=a.getType(w+16);"vide"==C?f=!0:"soun"==C&&(e=!0)}else if("mdhd"==D.type)v=this.parseMDHD(a,w+8),r=v.timeScale,v=v.duration;else if("minf"==D.type){var B=this.getNextTagOfTypeInDataView("stbl",a,w+8,D.size-8);if(void 0!=B)for(var C=!1,A=B.offset,B=B.size-8;!C;){var z=
...
d);this.updateAnalyzeProgress(100);return this.mp4Asset};b.prototype.generateSampleGroupTable=function(a,b){var c=new e.SampleGroupTable,d=a.durationTable.length,f=a.headerInfo.timeScale,g=a.headerInfo.durationInTrackTimeScale/f,q=a.sampleToChunkTable,l=a.chunkTable,r=a.durationTable,v=a.sampleTable,t=a.syncSampleTable,y=a.compositionTimeToSampleTimeTable,p=0,w=0,n;if(void 0!=y)for(p=0;p<y.length;p++)n=v.getSample(p),n.compositionTime=y[p];for(var y=q.size(),D=l.size(),C=0,p=0;p<y;p++){n=q.getSampleToChunk(p);
var B=n.samplesPerChunk;n=n.startChunk;var A;A=p==y-1?D+1:q.getSampleToChunk(p+1).startChunk;for(w=n-1;w<A-1;w++){n=l.getChunk(w);n.startSample=C;n.totalSamples=B;for(var z=n.offset,E=0;E<B;E++)n=v.getSample(C+E),n.offset=z,z+=n.size;C+=B}}l=q=0;if(b)if(void 0!=t)for(n=t.getSyncSample(0)-1,f=t.size(),q=y=0,p=1;p<=f;p++){l=d;p<f&&(l=t.getSyncSample(p)-1);g=new e.SampleGroup(n);for(w=n;w<l;w++)n=v.getSample(w),g.addSample(n.offset,n.size,q,r[y],n.compositionTime),q+=r[y],y++;c.addSampleGroup(g);n=l}else{q=
0;f=Math.floor(g);t=d%f;for(p=0;p<f-1;p++){l=(d-t)/f*p+1;g=new e.SampleGroup(l);for(w=0;w<(d-t)/f;w++)n=v.getSample(l+w),g.addSample(n.offset,n.size,q,r[l+w],n.compositionTime),q+=r[l+w];c.addSampleGroup(g)}l=(d-t)/f*(f-1)+1;g=new e.SampleGroup(l);for(p=l;p<d;p++)n=v.getSample(p),g.addSample(n.offset,n.size,q,r[p],n.compositionTime),q+=r[p];c.addSampleGroup(g)}else{for(p=t=q=0;p<this.mp4Asset.videoTrackInfo.sampleGroupTable.getSampleGroupsCount();p++){n=this.mp4Asset.videoTrackInfo.sampleGroupTable.getSampleGroup(p);
n=n.getSample(n.getSampleCount()-1);w=(n.duration+n.startTime)/this.mp4Asset.videoTrackInfo.timeScale*f;g=new e.SampleGroup(t);for(l=0;q<=w;){n=v.getSample(t+l);if(void 0==n)break;g.addSample(n.offset,n.size,q,r[t+l],n.compositionTime);q+=r[t+l];l++}t+=l;c.addSampleGroup(g)}for(p=t;p<d;p++)n=v.getSample(p),g=c.getSampleGroup(c.getSampleGroupsCount()-1),g.addSample(n.offset,n.size,q,r[p],n.compositionTime),q+=r[p]}return c};b.prototype.updateProcessMoovProgress=function(a){};b.prototype.updateAnalyzeProgress=
...
'" ');c+=">";c+="<BaseURL>";c+=a.url;c+="</BaseURL>";c+="</Representation>"});var c=c+"</AdaptationSet>",c=c+"</Period>",c=c+"</MPD>",e=new Blob([c],{type:"text/css"});return URL.createObjectURL(e)};b.prototype._kushGaugeBandwidth=function(a,b){void 0===b&&(b=4);var c=a.videoTrackInfo;return Math.floor(c.pixelWidth*c.pixelHeight*b*0.07)};b.prototype._getMP4Info=function(a){var d=this,c=$.Deferred(),e=$(a).attr("src"),f=parseFloat($(a).parent().data("duration"));isNaN(f)&&(f=parseFloat($(a).data("duration")),
isNaN(f)&&(f=0));(new com$adobe$ccv$mp4.MP4Parser).parse(e,f).then(function(a){var f;0==a.duration?(LOGGING&&Log.error(b._LOGTAG,"Can't calculate bandwidth for "+e+", because duration is 0.0"),c.reject()):(0<a.fileSize?(f=Math.floor(a.fileSize/a.duration),LOGGING&&Log.warn(b._LOGTAG,"Bandwidth (file size) = "+f+", file size: "+a.fileSize.toString()+" for "+e)):f=d._kushGaugeBandwidth(a),LOGGING&&Log.warn(b._LOGTAG,"Bandwidth (Kush Gauge) = "+d._kushGaugeBandwidth(a)+", implied file size: "+(d._kushGaugeBandwidth(a)*
a.duration).toString()+" for "+e));c.resolve({url:e,bandwidth:f,codecs:a.videoTrackInfo.codec})},function(){c.reject()});return c.promise()};b.prototype.createMPDUrlFromVideo=function(a,d){var c=this,e=$(a).find("source[type='video/mp4']"),f=$.Deferred(),k=[];e.each(function(a,d){var e=$(d),f=$.Deferred(),h={url:e.attr("src"),bandwidth:e.data("bandwidth"),codecs:e.data("codecs")},g=e.data("width"),r=e.data("height");g&&(h.width=g);r&&(h.height=r);h.bandwidth&&!isNaN(h.bandwidth)&&h.codecs&&h.codecs.length?
f.resolve(h):(LOGGING&&Log.info(b._LOGTAG,"Extracting bandwidth or codecs attribute from "+h.url),c._getMP4Info(e.get(0)).then(function(a){f.resolve(a)},function(){LOGGING&&Log.error(b._LOGTAG,"Missing bandwidth or codecs attribute at "+h.url);f.reject(e)}));k.push(f.promise())});$.when.apply(c,k).then(function(){for(var a=[],b=0;b<arguments.length;b++)a[b]=arguments[b];f.resolve(c._createMPDUrlFromInfos(a,d))},function(){f.reject()});return f.promise()};b.prototype.isDashSupported=function(a){void 0===
...
(function(e){var f=function(){function b(){}b.prototype.canPlayHLS=function(a){void 0===a&&(a=window);var b=a.navigator.userAgent,c=/Android/i.test(b),e=DOMUtil.getAndroidVersion(a),f=DOMUtil.getIOSVersion(a),f=DOMUtil.isIOSDevice()&&!isNaN(f)&&11<=f,b=c&&/webkit/i.test(b)&&!isNaN(e)&&4.2>e;return!(DOMUtil.isSafari(a)||DOMUtil.isIOSDevice()||c)||b||f||DOMUtil.isSamsungDevice(a)?!1:!0};b.prototype.isNativeHlSSupportEnabled=function(){return DOMUtil.isIOSDevice()||DOMUtil.isSafari()||DOMUtil.isFireFoxAndroid()};
...
0:1E3*b);return b};d.prototype._createPlayerForElement=function(a,b){var c=this,e=c.config.getConfigValue("rootdir"),f=a.find("video"),x=f.attr("poster")||c.config.getConfigValue("poster");c.authToken&&c.authToken.length&&-1==x.indexOf("Authorization='")&&(x+=(0>x.indexOf("?")?"?":"&")+"Authorization="+c.authToken);(DOMUtil.isAndroid()||DOMUtil.isIOSDevice())&&f.attr("poster",x);if(0==b.length)LOGGING&&Log.error(d._LOGTAG,"Can't find any tech to work with"),this.showError();else{var q=this.config.getConfigValue("bgcolor")?
this.config.getConfigValue("bgcolor"):"black";a.css("background-color",q);$("body").css("background-color",q);a.find("#video-js").css("background-color",q);this.config.getConfigValue("debug");x={techOrder:b,width:DOMUtil.windowInnerWidth(),height:DOMUtil.windowInnerHeight(),bgcolor:q,poster:x};this._player=null;VideoJSTechDetector.isNativeHlSSupportEnabled()||(videojs.options.hls.overrideNative=!0,videojs.options.html5.nativeAudioTracks=!1,videojs.options.html5.nativeVideoTracks=!1,videojs.options.html5.nativeTextTracks=
!1,videojs.Vhs.xhr.beforeRequest=function(a){if(-1==a.uri.indexOf("?")&&window.ccv$serverData&&window.ccv$serverData.m3u8URL){var b=new URL(window.ccv$serverData.m3u8URL),c=window.ccv$serverData.m3u8URL.indexOf("?");-1!=c&&a.uri.startsWith(b.origin)&&(b=window.ccv$serverData.m3u8URL.substr(c+1),a.uri=a.uri+"?"+b)}return a});var l=!1;videojs(f.get(0),x).ready(function(){function a(){LOGGING&&Log.info(d._LOGTAG,"*** handleFirstPlay");k||(LOGGING&&Log.info(d._LOGTAG,"*** handleFirstPlay: setTimeout()"),
k=window.setTimeout(function(){clearTimeout(k);k=0;f.off(VideoJSEvents.PLAY,a);c.onFirstPlay()},50))}function b(){LOGGING&&Log.info(d._LOGTAG,"*** handleFirstPause");k&&(clearTimeout(k),k=0,LOGGING&&Log.info(d._LOGTAG,"*** handleFirstPause: clearTimeout(playTimer);"));f.off(VideoJSEvents.PAUSE,b)}l=!0;c.hideErrors();var f=this,h=c.createCloudPlayer();c._player=f;c._cloudPlayer=h;h.setVideoJSPlayer(f);h.registerLoggerOnTimeUpdate(com$adobe$ccv$app.RenditionLogger.getInstance());h.attachTo(c.element,
...
(d=e[c],b.data(c,d),a.removeData(c));c=$("<div></div>");c.attr("id","html5-video-holder");c.append(a);a.addClass("video-js");a.data("account","2869242976001");a.data("player","7e1cd48d-2db9-4901-acc5-63e50cdec4ca");a.data("embed","default");a.data("id","");a=$("<div></div>");a.attr("id","video-surface");a.attr("tabindex","0");a.attr("aria-label","play");DOMUtil.isAndroidInternetBrowser()&&(a.css("background-color","transparent"),$("meta[name=viewport]").attr("content","minimum-scale=1.0,maximum-scale=1.0,user-scalable=yes"));
...
1:1,a.push(Number(f)));for(var k in e)this.analyticsHook.send({renditionName:k,count:e[k],ccvId:this.ccvId});for(b=0;b<a.length;b++)delete this.segmentPlaying[a[b]]}}catch(m){console.warn("Error in sending logs")}};a.prototype.onTIMEUPDATE=function(a){a=parseInt(a/6,10);this.segmentPlaying[a]||(this.segmentPlaying[a]=Date.now())};a.prototype.onVideoPaused=function(a){a=parseInt(a/6,10);this.segmentPlaying[a]&&delete this.segmentPlaying[a]};a.getInstance=function(){null==e.RenditionLogger.instance&&
